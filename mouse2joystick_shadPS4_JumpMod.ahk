...
;
;	Description:
;	A feeder script for a virtual joystick. Turns mouse and keyboard input into a virtual joystick input. Tweaked specifically for shadPS4 and Bloodborne. To be used with my "Jump on L3" mod. Requires ScpVBus to work.
;	
;	Notes:
;			-#q exit at any time.
;
...
; Icon
Menu,Tray,Tip, mouse2joystick for shadPS4 JumpMod
...
helpMenu:
	Msgbox,% 4 + 32 ,, If you need help with Mouse2Joystick, seek me out on GitHub.`n`nOpen link in browser?`nhttps://github.com/N3R4i/mouse2joystick_shadPS4_JumpMod
	IfMsgBox Yes
		Run, https://github.com/N3R4i/mouse2joystick_shadPS4_JumpMod
Return
...
GUI, Main:New, -MinimizeBox, % "Mouse2Joystick for shadPS4 JumpMod Settings  -  " . version
